...
namespace HikingStore.Data.Migrations
{
    ...
    [Migration("20230522173257_CreateDataBase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HikingStore.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("HikingStore.Models.Product", b =>
                {
                    b.HasOne("HikingStore.Models.Category", "Category")
                        .WithMany("Product")
                        .HasForeignKey("CatId")
            ...
            modelBuilder.Entity("HikingStore.Models.ShoppingCart", b =>
                {
                    b.HasOne("HikingStore.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
